...
export class Transaction {
  ...
  /**
   * Converts this Transaction instance to a plain JSON object for sending to the API
   */
  toJson(): any {
 ...
 */
export class PagedTransactions {
  @Expose()
  items: Transaction[];
  ...
  static fromJson(json: any): PagedTransactions {
    const response = plainToInstance(PagedTransactions, json, {
      excludeExtraneousValues: true
    });
 ...
 */
export class SyncTransactionsResponse {
  @Expose()
  count: number;
  ...
  static fromJson(json: any): SyncTransactionsResponse {
    return plainToInstance(SyncTransactionsResponse, json, {
      excludeExtraneousValues: true
    });
  }
} 