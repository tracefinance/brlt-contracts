              ...
              <form class="space-y-4" @submit.prevent="handleAddAddress">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="space-y-2">
                    ...
                    <Input
                      id="chainType" v-model="newAddress.chainType" placeholder="e.g., ethereum, bitcoin"
                      required />
                  </div>
                  <div class="space-y-2">
                    <Label for="address">Address</Label>
                    <Input id="address" v-model="newAddress.address" placeholder="Wallet address" required />
                  </div>
                </div>
                <div class="flex justify-end gap-2">
                  <Button type="button" variant="ghost" @click="showAddAddressForm = false">
                    Cancel
                  </Button>
                  <Button type="submit" :disabled="isAddingAddress || !newAddress.chainType || !newAddress.address">
                    Add Address
                  </Button>
                </div>
              </form>
