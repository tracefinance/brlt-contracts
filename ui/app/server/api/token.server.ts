...
export class TokenClient {
   ...
   */
  async verifyToken(address: string, chainType: string): Promise<Token> {
   ...
   * @returns Token details
   */
  async getToken(address: string, chainType: string): Promise<Token> {
   ...
   * @param chainType Blockchain network type
   */
  async deleteToken(address: string, chainType: string): Promise<void> {
    const endpoint = API_ENDPOINTS.TOKENS.BY_ADDRESS(address, chainType);
